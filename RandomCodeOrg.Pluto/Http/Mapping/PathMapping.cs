...
namespace RandomCodeOrg.Pluto.Http.Mapping {
    ...
    public class PathMapping {
        ...
        public string this[Uri u] {
            get {
                foreach (Regex key in mappings.Keys) {
                    if (key.IsMatch(u.LocalPath)) {
                        return BuildPath(key, u);
                    }
                }
                return null;
            }
        ...
        private readonly IDictionary<Regex, string> mappings = new Dictionary<Regex, string>();
        ...
        public void Map(string pattern, string path) {
            mappings.Add(new Regex(pattern, RegexOptions.IgnoreCase), path);
        }

        protected string BuildPath(Regex regex, Uri u) {
            var match = regex.Match(u.LocalPath);
            ...
            return BuildPath(mappings[regex], groupValues);
        }
